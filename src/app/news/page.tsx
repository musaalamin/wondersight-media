...
export default function NewsroomPage() {
  return (
    <main className="min-h-screen bg-[#120B21] text-white py-20 px-6">
      ...
      {/* Ad Placeholder for Adsterra/AdSense */}
      <div className="w-full h-32 bg-white/5 rounded-3xl border border-dashed border-white/10 flex items-center justify-center mb-20">
        <span className="text-gray-700 font-bold uppercase tracking-widest text-[10px]">Advertisement Placeholder</span>
      </div>
    </main>
  );
}